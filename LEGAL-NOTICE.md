...
**The game is not ours.** *The Goonies* was published by **Konami** for the MSX in 1986;
its catalogue number is **RC-734** and it is 32 KB. All rights over the game
...
The file `src/goonies.asm` is the commented disassembly of the cartridge. It is
...
If you worked on *The Goonies* or hold rights over the game, and you would rather this
