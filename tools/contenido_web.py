...
HALLAZGOS = {
    "es": [
        ("Las cuatro salas de un nivel no van en columna: van en un plano",
         ...
         "<code>0xF</code>: no hay- y el <b>alto es LA POSICION</b> de esa "
         "sala en el plano: los dos bits <b>altos son LA FILA</b> y los dos "
         "siguientes <b>LA COLUMNA</b>.</p>"
         "<p><b>Esto se publico al reves</b> el 2026-09-09, y lo caza "
         "theNestruo. Lo que lo decide no es ningun razonamiento sino el "
         "propio decorado: montado bien, las casillas encajan a lado y lado "
         "de cada juntura en el <b>77,8 %</b> de las verticales y el "
         "<b>56,6 %</b> de las horizontales; con los ejes cambiados, 0,4 % y "
         "0,0 %, que es POR DEBAJO del 10,8 % y el 7,2 % de comparar salas "
         "de niveles distintos. Y encaja con las dos tablas de paso: la sala "
         "de <code>0x52DB</code> esta siempre justo ENCIMA y la de "
         "<code>0x5327</code> siempre justo DEBAJO, en sus 38 entradas.</p>"
    ...
    "en": [
        ("The four rooms of a level are not a column: they are a plan",
         ...
         "(<code>0xF</code>: none) and the <b>high one is THE POSITION</b> "
         "of that room in the plan: the top two bits are <b>THE ROW</b> and "
         "the next two <b>THE COLUMN</b>.</p>"
         "<p><b>This went out the other way round</b> on 2026-09-09, and "
         "theNestruo caught it. What settles it is not an argument but the "
         "scenery itself: laid out right, the tiles match across each seam "
         "on <b>77.8 %</b> of the vertical ones and <b>56.6 %</b> of the "
         "horizontal; with the axes swapped, 0.4 % and 0.0 %, which is BELOW "
         "the 10.8 % and 7.2 % of comparing rooms from different levels. And "
         "it fits the two transition tables: the room <code>0x52DB</code> "
         "gives is always directly ABOVE and <code>0x5327</code>'s always "
         "directly BELOW, over their 38 entries each.</p>"
