...
# la portada y una octava propia de este cartucho: los VEINTICINCO niveles
# dibujados, que son cien salas y no caben en la pagina del juego.
...
_PAREJAS = [("GETTING-STARTED.html", "EMPEZAR.html"),
            ...
            ("THE-LEVELS.html", "LOS-NIVELES.html"),
...
# la casa, con el titulo en katakana y el 0x34 del RC-734. Creditos de personas
# no hay ninguno.
PIE = {
    "es": "<em>The Goonies</em> lo publico Konami para MSX en 1986; su numero de catalogo es RC-734 y son 32 KB. El juego se basa en la pelicula de Richard Donner (Warner Bros., 1985). Todos los derechos sobre el juego siguen siendo de sus titulares. Este trabajo es de preservacion, estudio y documentacion, y la imagen del cartucho no se distribuye.",
    "en": "<em>The Goonies</em> was published by Konami for the MSX in 1986; its catalogue number is RC-734 and it is 32 KB. The game is based on the Richard Donner film (Warner Bros., 1985). All rights in the game remain with their holders. This is preservation, study and documentation work, and the cartridge image is not distributed.",
}
...
def main(docdir, idioma="en"):
    ...
    for fn in sorted(os.listdir(docdir)):
        ...
        titulo = (m.group(1) if m else fn[:-3]) + " — The Goonies (Konami, 1986)"
